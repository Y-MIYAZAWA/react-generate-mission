...
type BarChartProps = {
  ...
  setData: Dispatch<SetStateAction<BarChartData[]>>
  index: number,
...
export const BarChartDataInputModal = (props: BarChartProps) => {
  const {register, handleSubmit, reset} = useForm<BarChartForm>();
  const onSubmit: SubmitHandler<BarChartForm> = (data) => {
